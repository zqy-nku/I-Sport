	...
	<div class="container">
		...
		<div class="container">
			<div class="blog-header">
				...
				<img src="image/1.jpg" width="150" class="img-rounded">&nbsp;<span
					class="blog-description">&nbsp;&nbsp;&nbsp;<a href="#">${sessionScope.person.nickname}</a></span>
				&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#"><button
						type="button" class="btn btn-large btn-danger">+ 添加好友</button></a>
				</h4>
			...
			<div class="col-sm-8 blog-main">
				...
				<div class="blog-post">
					...
					<div style="margin-top: -16px; margin-left: -39px; color: #002233;">
						...
						<hr>
						<h11 class="blog-post-title">最新说说</h11>
						<hr>
						<!-- 显示所有说说 -->
							<blockquote>
								<h3>
