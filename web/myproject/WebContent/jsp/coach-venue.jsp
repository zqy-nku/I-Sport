...
<c:if test="${empty requestScope.lstCoach}">
	<script>
	
	window.location="/myproject/showCoachVenueServlet?sportid=1";
		...
		<div class="col-md-6 span1_of_2"><!-- start span1_of_3 style2 -->
			<div class="grid2_of_1" style="height:900px; width:800px; margin-left:-120px;">
                ...
                <div class="head-one text-center team-head">
								<h3>教练信息</h3>
                               <div align="right"><a  class="btn btn-sm btn-default" href="/myproject/showCoachListServlet?sportid=${requestScope.sportid}" role="button">点击查看更多&raquo;</a></div>
								<span> </span>
								<p>There are lots of excellent coaches waitting for you~~~</p>
							</div>	
...
<c:forEach items="${requestScope.lstCoach}" var="coach" >
								<div class="col-md-3">
									<div class="team-member text-center">
										...
										<p align="center">
									<a class="btn btn-info" href="/myproject/viewCoachDetailServlet?coachid=${coach.coachid}&sportid=${requestScope.sportid}" role="button">View details &raquo;</a>
								</p>
				...
				<hr>
                    <div class="table-responsive">
                     <div class="head-one text-center team-head">
								<h3>场馆信息</h3>
                                <div align="left"><form name="sort1" class="navbar-form navbar-right" >
							<h9>
							 <select id="sort" name="sort">
									<option value="1" >默认</option>
									<option value="2" >按价格排列</option>
									<option value="3">按评分排列</option>
								</select>
							</h9>
						</form></div>
								<span> </span>
								<p>Welcome to your coming~~~</p>
							</div>	
							 <div id="containe">
                         
                         <div class="scroll-pana">
						<table class="table table-striped">
							<thead bgcolor="#CCFF33">
								<tr>
									<th bgcolor="#ccc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;场馆名称</th>
									<th bgcolor="#ccc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格（元/小时）</th>
									<th bgcolor="#ccc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址</th>
									<th bgcolor="#ccc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评分</th>
									<th bgcolor="#ccc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;详细信息</th>
								</tr>
							</thead>
							<tbody bgcolor="#fff">
					<c:forEach items="${requestScope.lstVenue }" var="venue" >
								<tr>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${venue.venuename}</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${venue.venprice}</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${venue.venplace}</td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${venue.vencomgrade}</td>
									<td><p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="/myproject/viewVenueDetailServlet?venueid=${venue.venueid}&sportid=${requestScope.sportid}" role="button">更多&raquo;</a>
										</p></td>
								</tr>
					</c:forEach>
