...
public class Activityinvitation implements Serializable {
	...
	public Activityinvitation(int actiid, int sportid, int userid,
			...
			Date actisettime, String actiuserid, int actiusercount,
			String acticont, String actiplace, Date actiendtime, int actidianzan) {
		super();
		this.actiid = actiid;
	...
	/**
	 * @return the actiuserid
	 */
	public String getActiuserid() {
		return actiuserid;
	}
	/**
	 * @param actiuserid the actiuserid to set
	 */
	public void setActiuserid(String actiuserid) {
		this.actiuserid = actiuserid;
	}
	/**
	...
	public String toString() {
		return "Activityinvitation [actiid=" + actiid + ", sportid=" + sportid
				...
				+ ", actisettime=" + actisettime + ", actiuserid=" + actiuserid
				+ ", actiusercount=" + actiusercount + ", acticont=" + acticont
				+ ", actiplace=" + actiplace + ", actiendtime=" + actiendtime
				+ ", actidianzan=" + actidianzan + "]";
	}
