...
public class ActivityinvitationDaoImpl implements IActivityinvitationDao {
	...
	public int insertActivityinvitation(Activityinvitation activityinvitation) {
		...
		String actiuserid = activityinvitation.getActiuserid();
		...
		int actidianzan=activityinvitation.getActidianzan();
		...
		Object[] params = new Object[] { sportid, userid, actiname,
				actibegtime, actiissucc, actisettime, actiuserid,
				actiusercount, acticont, actiplace, actiendtime,actidianzan};
	...
	public int updateActivityinvitation(Activityinvitation activityinvitation) {
		...
		TransactionManager.beginTransaction();
		// ����3������SQL���ģ��
		String strSQL = "update activityinvitation set sportid=?, userid=?, actiname=?,actibegtime=?,actiissucc=?, actisettime=?,actiuserid=?,actiusercount=?, acticont=?, actiplace=?, actiendtime=?,actidianzan=? where actiid=?";
		Object[] params = new Object[] { activityinvitation.getSportid(),
				...
				activityinvitation.getActiuserid(),
				...
				activityinvitation.getActidianzan(),
	...
	public List<Activityinvitation> selectAllActivityinvitation() {
		...
		//
		String strSQL = "select * from Activityinvitation order by actiid";
		//
		...
		try {
			while (resultSet.next()) {
				...
				activityinvitation.setActiuserid(resultSet.getString(8));
				activityinvitation.setActiusercount(resultSet.getInt(9));
				activityinvitation.setActicont(resultSet.getString(10));
				activityinvitation.setActiplace(resultSet.getString(11));
				activityinvitation.setActiendtime(resultSet.getDate(12));
                activityinvitation.setActidianzan(resultSet.getInt(13));
				// ����5-2������װ�õĶ�����ӵ�List������
	...
	public Activityinvitation selectActivityinvitationById(int actiid) {
		...
		this.conn = this.connectionManager.openConnection();
		// ����2������SQL���ģ��
		String strSQL = "select * from activityinvitation where actiid=? order by actisettime asc";
	...
	public int deleteActivityinvitationById(int actiid) {
		...
		TransactionManager.beginTransaction();
		// ����3������SQL���ģ��
		String strSQL = "delete from activityinvitation where actiid=? order by actisettime asc";
		Object[] params = new Object[] { actiid };
		// ����4������dbutils�еķ�����ɶ���ݿ��ɾ�����
		int affectedRows = this.dbUtils.execOthers(conn, strSQL, params);
		// ����5����ݲ���4�Ĳ�������ύ��ع�����
	...
	public List<Activityinvitation> selectByActiname(String actiname) {
		...
		this.conn = connectionManager.openConnection();
		// 步骤3：创建查询语句的模板
		String strSQL = "select * from activityinvitation where actiname=? order by actisettime asc";
	...
	public List<Activityinvitation> selectBySportid(int sportid) {
		...
		this.conn = connectionManager.openConnection();
		// 步骤3：创建查询语句的模板
		String strSQL = "select * from activityinvitation where sportid=? order by actisettime asc";
	...
	public List<Activityinvitation> selectByUserid(int userid) {
		...
		this.conn = connectionManager.openConnection();
		// 步骤3：创建查询语句的模板
		String strSQL = "select * from activityinvitation where userid=? order by actisettime asc";
	...
	public List<Activityinvitation> selectByActibegtime(Date actibegtime) {
		...
		this.conn = connectionManager.openConnection();
		// 步骤3：创建查询语句的模板
		String strSQL = "select * from activityinvitation where actibegtime=? order by actisettime asc";
