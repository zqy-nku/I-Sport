...
public class MainActivity extends ListActivity {
	...
	private Button btnTui, btnRe, btnJoined;
	private int userid;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		this.btnTui=(Button)super.findViewById(R.id.butTui);
		this.btnRe=(Button)super.findViewById(R.id.butRe);
		this.btnJoined=(Button)super.findViewById(R.id.btnJoined);
		// 设置适配器
		...
		this.btnTui.setOnClickListener(new ViewOcl());
		this.btnRe.setOnClickListener(new ViewOcl());
		this.btnJoined.setOnClickListener(new ViewOcl());
	...
	private List<Map<String, ?>> fetchData() {
		...
		String response = WebAccessUtils.httpRequest("allActiServlet");
		System.out.println("response="+response);
		// 步骤4-3：设置一个全新的类型Type
		...
		for (Actihuo acti: lstActi) {
			...
			item01.put("userid", MainActivity.this.userid);
			item01.put("actiid", acti.getActiid());
			item01.put("actiPhoto", R.drawable.user);
	...
	private class ViewOcl implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
			case R.id.butTui:
				Toast.makeText(getApplicationContext(), "您要查看推荐活动",
						Toast.LENGTH_LONG).show();
				// 界面跳转
				Intent intent1 = new Intent();
				intent1.setClass(MainActivity.this, TuiActivity.class);
				startActivity(intent1);
				break;
			case R.id.butRe:

				Toast.makeText(getApplicationContext(), "您要查看热门活动",
						Toast.LENGTH_LONG).show();
				// 界面跳转
				Intent intent2 = new Intent();
				intent2.setClass(MainActivity.this, ReActivity.class);
				startActivity(intent2);

				break;
			case R.id.btnJoined:
				Toast.makeText(getApplicationContext(), "您要查看参加的活动",
						Toast.LENGTH_LONG).show();
				// 界面跳转
				Intent intent3 = new Intent();
				intent3.setClass(MainActivity.this, JoinedActivity.class);
